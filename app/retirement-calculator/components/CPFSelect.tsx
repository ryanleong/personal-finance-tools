    ...
    <div className="flex flex-col gap-2.5">
      ...
      <div className="relative">
        <select
          ...
          className="w-full bg-input border border-border rounded-lg px-3 py-2.5 pr-8 text-sm text-foreground focus:outline-none focus:border-[#ff2d78] focus:ring-1 focus:ring-[#ff2d78]/20 transition-colors duration-150 appearance-none cursor-pointer"
        >
